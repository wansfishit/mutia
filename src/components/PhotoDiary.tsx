...
const photoCards: CutePhoto[] = [
  ...
  },
  {
    ...
    sticker: '💐',
    note: 'Kejutan buket mawar biru spesial buat Kharisma Mutia tersayang! Senyum bahagia kamu waktu itu selalu jadi momen paling berharga buat aku.',
    rotation: 'rotate-2',
  ...
  },
  {
    ...
    sticker: '🥰',
    note: 'Senyum paling bahagia! Makasih ya Sayang udah selalu jadi alasan aku tersenyum setiap hari.',
    rotation: 'rotate-1',
    tapeColor: 'bg-pastel-yellow/80',
  },
];
